...
const NOTES = [
  ...
  '',
  'IN-APP PURCHASES',
  'The 7 In-App Purchases submitted with this build are unchanged and were already',
  'verified in sandbox: gold_100, gold_500, gold_1500, gold_5000, premium30,',
  'premium90, premium365. Store (shop icon) -> "Altin" tab -> "Satin Al". All',
  'purchases go through StoreKit; there is no web payment in the app.',
  '',
  '--- Turkce ozet ---',
