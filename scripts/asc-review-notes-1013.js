...
const NOTES = [
  ...
  '   "Katil" to enter.',
  '',
  'Please note that AZAP is a party game for friends sitting together, and',
  'starting a round needs at least 4 players, so with two devices the lobby',
  'will answer "En az 4 oyuncu!" if you tap start. Joining a room, which is',
  'what this issue was about, is fully testable with two devices.',
  '',
  '=== UNCHANGED ===',
